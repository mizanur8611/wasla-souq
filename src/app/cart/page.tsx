...
export default function CartPage() {
  ...
  return (
    <div>
      <h1 className="mb-1 font-display text-xl font-bold text-ink">Your order</h1>
        ...
        {lines.map((line) => (
          <div key={line.catalogItemId} className="flex items-center gap-3 rounded-2xl bg-paper p-3">
            <div className="min-w-0 flex-1">
              <div className="text-sm font-semibold text-ink">{line.name}</div>
      ...
      <div className="mt-5 flex items-start gap-2 rounded-2xl bg-goldsoft p-3 text-xs font-bold text-[#8a611f]">
        ...
        No surge. Flat fee. Always shown upfront.
      </div>
